...
public class CountryDataGenerator {
    public static List<Country> getCountries() {
        ...
        gb.addQuestion(new Question("What is the size of United Kingdom (in square kilometres)?", new String[]{"243'610", "320'740", "276'331", "307'022"}, 0, 11, 9, true));
        ...
        uk.addQuestion(new Question("What is the size of Great Britain in 1850 (in square kilometres)?", new String[]{"243'610", "225'600", "326'544", "300'869"}, 0, 5, 13, true));
