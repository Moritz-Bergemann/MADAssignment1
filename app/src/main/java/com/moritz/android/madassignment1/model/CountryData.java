...
public class CountryData {
    public static List<Country> getCountries() {
        ...
        countryList.add(ag);
        ag.addQuestion(new Question("What is the capital city of Antigua and Barbuda?", new String[]{"St. John's", "Potters Village", "All Saints", "Codrington"}, 0, 10, 17, false));
        ...
        ag.addQuestion(new Question("What is the GDP of Antigua and Barbuda?", new String[]{"1,727,759,259 USD", "1,057,868,944 USD", "2,064,623,279 USD", "1,633,266,668 USD", "1,468,546,859 USD"}, 0, 12, 5, false));
        ...
        ag.addQuestion(new Question("What is the size of Antigua and Barbuda?", new String[]{"443", "228", "600", "480"}, 0, 18, 15, false));
        ...
        ai.addQuestion(new Question("What is the GDP of Anguilla?", new String[]{"108,900,000 USD", "130,542,516 USD", "69,388,604 USD", "147,331,119 USD", "75,852,811 USD"}, 0, 10, 14, false));
        ...
        az.addQuestion(new Question("What is the population of Azerbaijan?", new String[]{"10'023'318", "44023519", "500'049"}, 0, 17, 20, false));
        az.addQuestion(new Question("What is the GDP of Azerbaijan?", new String[]{"39,207,000,000 USD", "39,442,033,329 USD", "55,573,324,798 USD", "35,304,006,879 USD", "23,800,749,480 USD"}, 0, 11, 20, false));
        ...
        bb.addQuestion(new Question("What is the GDP of Barbados?", new String[]{"5,209,000,000 USD", "4,430,999,330 USD", "7,026,401,703 USD", "6,531,917,513 USD", "5,506,015,816 USD"}, 0, 16, 8, false));
        bb.addQuestion(new Question("What is the name of the largest city (by population) in Barbados?", new String[]{"Bridgetown", "Holetown", "Speightstown"}, 0, 10, 15, false));
        ...
        bd.addQuestion(new Question("What is the GDP of Bangladesh?", new String[]{"302,571,254,131 USD", "418,338,717,877 USD", "196,510,283,393 USD", "235,563,125,418 USD", "271,423,918,097 USD"}, 0, 20, 19, false));
        ...
        bd.addQuestion(new Question("What is the size of Bangladesh?", new String[]{"148'460", "168'896", "196'405", "197'800"}, 0, 11, 17, false));
        ...
        bf.addQuestion(new Question("What is the population of Burkina Faso?", new String[]{"20'321'378", "1'028'462", "602'392"}, 0, 16, 14, false));
        bf.addQuestion(new Question("What is the GDP of Burkina Faso?", new String[]{"15,745,810,235 USD", "11,385,429,666 USD", "13,494,051,917 USD", "18,446,301,643 USD", "23,184,531,748 USD"}, 0, 11, 14, false));
        ...
        countryList.add(br);
        br.addQuestion(new Question("What is the capital city of Brazil?", new String[]{"Brasília", "Rio De Janeiro", "Sao Paulo", "Manaus"}, 0, 15, 7, false));
        ...
        br.addQuestion(new Question("What is the GDP of Brazil?", new String[]{"1,839,758,040,766 USD", "2,108,032,582,974 USD", "2,485,822,548,216 USD", "2,016,191,748,722 USD", "1,661,293,105,204 USD"}, 0, 18, 16, false));
        ...
        ch.addQuestion(new Question("What is the GDP of Switzerland?", new String[]{"703,082,435,360 USD", "474,768,105,463 USD", "531,575,808,760 USD", "637,820,681,046 USD", "596,869,748,787 USD"}, 0, 14, 14, false));
        ...
        ch.addQuestion(new Question("What is the size of Switzerland?", new String[]{"41'277", "30'272", "36'850", "33'726"}, 0, 18, 13, false));
        ...
        cz.addQuestion(new Question("What is the GDP of Czech Republic?", new String[]{"246,489,245,495 USD", "175,086,499,168 USD", "314,273,917,306 USD", "244,127,872,976 USD", "180,742,455,387 USD"}, 0, 17, 18, false));
        ...
        dk.addQuestion(new Question("What is the GDP of Denmark?", new String[]{"348,078,018,464 USD", "249,878,724,214 USD", "214,239,089,916 USD", "250,934,643,683 USD", "509,809,279,956 USD"}, 0, 13, 9, false));
        dk.addQuestion(new Question("What is the name of the largest city (by population) in Denmark?", new String[]{"Copenhagen", "Aarhus", "Aalborg", "Odense"}, 0, 7, 17, false));
        ...
        gb.addQuestion(new Question("What is the GDP of United Kingdom?", new String[]{"2,827,113,184,696 USD", "3,781,380,993,136 USD", "3,194,638,330,690 USD", "2,571,620,944,521 USD", "2,284,422,410,969 USD"}, 0, 6, 11, false));
        ...
        gb.addQuestion(new Question("What is the size of United Kingdom?", new String[]{"243'610", "320'740", "276'331", "307'022"}, 0, 11, 9, false));

        Country hk = new Country("Hong Kong", R.drawable.flag_hk);
        countryList.add(hk);
        hk.addQuestion(new Question("What is the capital city of Hong Kong?", new String[]{"REMOVE THIS IT DOESN'T MAKE SENSE"}, 0, 6, 6, false));
                hk.addQuestion(new Question("What is the population of Hong Kong?", new String[]{"7'507'400", "8'901'342", "913'648"}, 0, 17, 15, false));
        hk.addQuestion(new Question("What is the GDP of Hong Kong?", new String[]{"366,029,556,273 USD", "379,835,079,007 USD", "342,061,025,844 USD", "413,882,269,172 USD", "282,187,712,161 USD"}, 0, 7, 7, false));
        ...
        jp.addQuestion(new Question("What is the GDP of Japan?", new String[]{"5,081,769,542,380 USD", "5,725,550,296,748 USD", "3,569,317,859,902 USD", "5,933,602,053,895 USD", "7,535,220,528,979 USD"}, 0, 17, 11, false));
        ...
        kr.addQuestion(new Question("What is the GDP of South Korea?", new String[]{"2,029,000,000,000 USD", "1,658,492,086,721 USD", "2,566,351,900,758 USD", "1,106,958,560,685 USD", "1,374,917,028,215 USD"}, 0, 16, 16, false));
        ...
        kr.addQuestion(new Question("What is the size of South Korea?", new String[]{"99'720", "109'203", "135'707", "56'426"}, 0, 17, 8, false));

        Country uk = new Country("Great Britain in 1850", R.drawable.flag_uk);
        countryList.add(uk);
        uk.addQuestion(new Question("What is the capital city of Great Britain in 1850?", new String[]{"London", "Liverpool", "Glasgow", "Manchester"}, 0, 17, 12, false));
        uk.addQuestion(new Question("What is the population of Great Britain in 1850?", new String[]{"27'000'000", "16'000'000", "4'000'000", "1'000'000"}, 0, 5, 16, false));
        uk.addQuestion(new Question("What is the GDP of Great Britain in 1850?", new String[]{"114,696,000,000 USD", "140,216,723,903 USD", "141,548,084,506 USD", "64,637,631,747 USD", "151,842,645,554 USD"}, 0, 15, 18, false));
        uk.addQuestion(new Question("What is the name of the largest city (by population) in Great Britain in 1850?", new String[]{"London", "Liverpool", "Glasgow", "Manchester"}, 0, 16, 6, false));
        uk.addQuestion(new Question("What is the size of Great Britain in 1850?", new String[]{"243'610", "225'600", "326'544", "300'869"}, 0, 5, 13, false));

        Country vn = new Country("Vietnam", R.drawable.flag_vn);
        countryList.add(vn);
        vn.addQuestion(new Question("What is the capital city of Vietnam?", new String[]{"Hanoi", "Ho Chi Minh City", "Da Nang", "Hue"}, 0, 19, 19, false));
        ...
        vn.addQuestion(new Question("What is the GDP of Vietnam?", new String[]{"261,921,244,843 USD", "306,879,694,553 USD", "339,603,290,383 USD", "143,478,475,212 USD", "346,581,179,475 USD"}, 0, 5, 10, false));
